...
public class CatchBox extends JComponent { // CatchBox is the area in which notes can be caught
    ...
    public CatchBox(int x, int y, int w, int h, int s) { // constructor for CatchBox takes in x position, y position, width, height, and speed of fade
        ...
        setBounds(0, 0, 800, 1024); // set bounds so the component appears in absolute positioning
    }
